...
# OpenCV 人脸检测
file_xml = r"C:/Users/jiaoy/Desktop/python/simple_pj/Christmas_hat/haarcascade_frontalface_default.xml"
face_patterns = cv2.CascadeClassifier('haarcascade_frontalface_default.xml')
face_patterns.load(file_xml)

sample_image = cv2.imread('C:/Users/jiaoy/Desktop/python/simple_pj/Christmas_hat/img/face2.jpg')
faces = face_patterns.detectMultiScale(sample_image, scaleFactor=1.1, minNeighbors=8, minSize=(50, 50))



# for (x,y,h,w) in faces:
#     sample_image = cv2.rectangle(sample_image,(x,y),(x+w,y+h),(255,0,0),2)
# cv2.imshow('face_dected',sample_image)
# cv2.waitKey(0)
